...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <div id="body" class="clear fr_offer">
		...
		<div id="main" class="left">
			<div id="border-form">
				<form id="myform" action="send_form_email.php" method="post">
					<h2>Inscrivez-vous pour profiter de votre avantage</h2>
					<hr />
	                <label>Email *<input id="email" name="email" type="email" /></label>
	                <label>Nom et prénom *<input id="name" name="name" type="text" /></label>
                    <div style="clear: both;"></div>
    ...
    <!-- Form Handlers -->
    <script type="text/javascript" src="js/scripts-fr.js"></script>  
    </body>
</html>