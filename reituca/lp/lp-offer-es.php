...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <div id="body" class="clear es_offer">
		...
		<div id="main" class="left">
			<div id="border-form">
				<form id="myform" action="send_form_email.php" method="post">
					<h2>Regístrese aquí para recibir su guía de forex gratuita</h2>
					<hr />
	                <label>Email *<input id="email" name="email" type="email" /></label>
	                <label>Nombre y Apellido *<input id="name" name="name" type="text" /></label>
                    <div style="clear: both;"></div>
					...
					<label>Telefono * <input id="phone" name="phone" type="phone" maxlength="16"/></label>
                    <input style="display: none;" id="token" name="token" type="token" value="lp_offer_<?php echo $form_lang; ?>"/>
					<input type="submit" value="Aplicar ahora" />
				</form>
    ...
    <!-- Form Handlers -->
    <script type="text/javascript" src="js/scripts-es.js"></script>  
    </body>
</html>