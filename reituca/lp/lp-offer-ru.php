...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <div id="body" class="clear ru_offer body_ru">
		<div id="aside" class="left">
			
		</div>
        <div style="clear: both;"></div>
		<div id="main" class="left main_ru">
			<div id="border-form" class="main_ru">
				<form id="myform" action="send_form_email.php" method="post">
					
					<br /><br /><br />
	                <label>E-mail *<input id="email" name="email" type="email" /></label>
	                <label>имя *<input id="name" name="name" type="text" /></label>
                    <div style="clear: both;"></div>
					...
					<label>телефон * <input id="phone" name="phone" type="phone" maxlength="16"/></label>
                    <input style="display: none;" id="token" name="token" type="token" value="lp_offer_<?php echo $form_lang; ?>"/>
					<input type="submit" value="заниматься" />
				</form>
	            <div id="success" class="success_ru">Благодарим Вас за обращение к нам! Мы свяжемся с вами как можно скорее.</div>
			</div>
	</div>
</div>
    <div style="clear: both;"></div>
	<div id="footer">
		<p><?php echo $lp_footer_txt_ru; ?></p>
    ...
    <!-- Form Handlers -->
    <script type="text/javascript" src="js/scripts-ru.js"></script>  
    </body>
</html>