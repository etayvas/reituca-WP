...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <style type="text/css">
            form{direction:rtl}#name,#email{float:right;margin-right:0;margin-left:40px;width:300px}#countries,#country_code,#phone{float:right}.select.single .select-arrow{background-position:0 -48px;float:left;right:270px}.select.single .select-value{padding:1px 5px}.error{padding-right:5px}#footer{direction:rtl}#success{text-align:right}
        </style>
    </head>
    <body>
        <!--[if lt IE 7]>
    ...
    <div id="body" class="clear arab_offer">
		...
		<div id="main" class="left">
			<div id="border-form">
				<form id="myform" action="send_form_email.php" method="post">
					<h2>سجل الان واطلب حزمتك</h2>
					<hr />
	                <label>البريد الإلكتروني *<input id="email" name="email" type="email" /></label>
	                <label>الاسم *<input id="name" name="name" type="text" /></label>
                    <div style="clear: both;"></div>
                    <label>هاتف * <input id="phone" name="phone" type="phone" maxlength="16"/></label>
	                <input id="country_code" class="c_code_class" name="country_code" type="country_code"/>
                    <select id="countries" name="countries">
						<option value="Select a country" cnCode="--" >الدولة</option>
					...
					<input type="submit" value="ابدأ التداول اليوم" />
				</form>
	            <div id="success">شكرا!</div>
			</div>
	</div>
</div>
    <div style="clear: both;"></div>
	<div id="footer">
		<p><?php echo $lp_footer_txt_ar ?></p>
    ...
    <!-- Form Handlers -->
    <script type="text/javascript" src="js/scripts-arab.js"></script>  
    </body>
</html>