...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <div id="body" class="clear en_offer">
		...
		<div id="main" class="left">
			<div id="border-form">
				<form id="myform" action="send_form_email.php" method="post">
					<h2>Register here to receive your free XForex trader package</h2>
					<hr />
	                <label>Email address *<input id="email" name="email" type="email" /></label>
	                <label>Full Name *<input id="name" name="name" type="text" /></label>
                    <div style="clear: both;"></div>
					...
					<label>Telephone * <input id="phone" name="phone" type="phone" maxlength="16"/></label>
                    <input style="display: none;" id="token" name="token" type="token" value="lp_offer_<?php echo $form_lang; ?>"/>
					<input type="submit" value="Apply Now" />
				</form>
	            <div id="success">Details received! You're on the right track!</div>
			</div>
	</div>
</div>
    <div style="clear: both;"></div>
	<div id="footer">
		<p><?php echo $lp_footer_txt_en; ?></p>
