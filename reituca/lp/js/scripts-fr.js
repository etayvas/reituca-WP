...
jQuery.validator.addMethod("lettersonly", function(value, element) {
 ...
 $("#myform").validate({
   ...
   messages: {
     name: {
       required: " Veuillez saisir un nom valide.",
       minlength: jQuery.format(" Veuillez saisir un nom valide.")
     ...
     phone: {
       ...
       rangelength: jQuery.format(" Veuillez saisir un numéro de téléphone valide.")
     },
     country_code: {
       required: " ",
