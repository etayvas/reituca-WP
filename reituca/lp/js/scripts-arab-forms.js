...
jQuery(document).ready(function() { 
	...
	jQuery('#countries1').on('change', function() { updateCountryCode1(); });
	updateCountryCode1();
    
   	jQuery('#countries3').on('change', function() { updateCountryCode3(); });
	updateCountryCode3();
});
...
var updateCountryCode1 = function() {
	var countryCode1 = jQuery('#countries1 option:selected').attr('cnCode1');
	jQuery('.c_code_class1').val(countryCode1);
};
var updateCountryCode3 = function() {
	var countryCode3 = jQuery('#countries3 option:selected').attr('cnCode3');
	jQuery('.c_code_class3').val(countryCode3);
};
...
$(document).ready(function() {
   ...
   messages: {
     name: {
       required: " الرجاء إدخال اسم صالح.",
       minlength: jQuery.format(" الرجاء إدخال اسم صالح.")
     },
     email: {
       required: " الرجاء إدخال بريد الكتروني صالح.",
       email: " الرجاء إدخال بريد الكتروني صالح."
     },
     phone: {
       required: " الرجاء إدخال رقم هاتف صالح.",
       rangelength: jQuery.format(" الرجاء إدخال رقم هاتف صالح.")
     },
     country_code: {
       required: " ",
