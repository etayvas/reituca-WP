    ...
    if (! class_exists("GFPopupWidget")) {
		...
		if (empty($instance['gf_widget_btn_text'])){
            ...
            function form ($instance)
            {
                ...
                $instance = wp_parse_args((array) $instance, array('title' => __("Contact Us", "gravity-forms-popup-widget"), 'tabindex' => '11'));
                ?>
<hr />
<p><label
	for="<?php
